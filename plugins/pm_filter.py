...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
        ...
        buttons = [[
            ...
            InlineKeyboardButton('Grub', url='https://t.me/art2work_grub'),
            InlineKeyboardButton('movie', url='https://t.me/art2work_movie')
            ],[
...
async def advantage_spell_chok(msg):
    ...
    m = await msg.reply(f"Hey, {msg.from_user.mention}!\nAku tidak menemukan film dengan judul itu\nApa judul film di bawah ini yang kamu cari?", reply_markup=InlineKeyboardMarkup(btn))
