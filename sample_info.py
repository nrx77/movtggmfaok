...
CUSTOM_FILE_CAPTION = environ.get("CUSTOM_FILE_CAPTION", "<code>{file_name}</code>\n\n<b>Size:</b> {file_size}\n\n{file_caption}\n\n<b>[© Movie Request⚡](https://t.me/+iXFDwdXc_FswZTNl)</b>")
IMDB_TEMPLATE = environ.get("IMDB_TEMPLATE", "<b>🎬 Judul:</b> <a href={url}>{title}</a>\n<b>📺 Type:</b> {kind}\n<b>📆 Rilis:</b> <a href={url}/releaseinfo>{release_date}</a>\n<b>🌟 Rating:</b> <a href={url}/ratings>{rating} / 10</a>\n(based on <code>{votes}</code> user ratings.)\n\n<b>📀 Runtime:</b> <code>{runtime} minutes</code>\n<b>🎭 Genres:</b> {genres}\n\n<b>☀️ Languages:</b> {languages}\n<b>🎛 Countries:</b> {countries}\n<b>🎥 Director:</b> {director}\n<b>📝 Writers:</b> {writer}\n\n<b><a href='https://t.me/+iXFDwdXc_FswZTNl'>© Movie Request⚡</a></b>")
